    ...
    ui.registerMenuItem("Paint Area", function () {
        if (ui.tool && ui.tool.id == "repainter-tool") {
            ...
            if (window == null) {
                ...
                window.setWidth(300);
                var label = new Oui.Widgets.Label("Select Colors and Drag an area to paint");
                window.addChild(label);
                var groupbox = new Oui.GroupBox("Colors");
                window.addChild(groupbox);

                var primary = new Oui.Widgets.ColorPicker(function (color) {
                    myPrimaryColor = color;
                    console.log(myPrimaryColor);
                });
                groupbox.addChild(primary);
                var secondary = new Oui.Widgets.ColorPicker(function (color) {
